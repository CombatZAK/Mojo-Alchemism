...
public class PulverizerUpdates {
	...
	private PulverizerUpdates() {
		...
		this.pulverizerActions.add(new SubstitutePulverizerAction(new ItemStack(ProjectRedCore.itemPart(), 1, 39), new ItemStack(ProjectRedCore.itemPart(), 1, 39)));
		this.pulverizerActions.add(new SubstitutePulverizerAction(new ItemStack(ProjectRedCore.itemPart(), 1, 38), new ItemStack(ProjectRedCore.itemPart(), 1, 38)));
		this.pulverizerActions.add(new SubstitutePulverizerAction(new ItemStack(ProjectRedCore.itemPart(), 1, 37), new ItemStack(ProjectRedCore.itemPart(), 1, 37)));
		this.pulverizerActions.add(new SubstitutePulverizerAction(ItemApi.getItem("itemResource", 6), ItemApi.getItem("itemResource", 6)));
