...
public class RenameUpdates {
	...
	private RenameUpdates() {
		...
		//rename Thermal Foundations Mana Infused Metal to Mithril
		this.renameActions.add(new RenameItemAction(TFItems.dustMithril, "Pulverized Mithril"));
		this.renameActions.add(new RenameItemAction(TFItems.ingotMithril, "Mithril Ingot"));
		this.renameActions.add(new RenameItemAction(TFItems.nuggetMithril, "Mithril Nugget"));
		this.renameActions.add(new RenameItemAction(TFItems.gearMithril, "Mithril Gear"));
		this.renameActions.add(new RenameItemAction(TFBlocks.blockStorage.blockMithril, "Mithril Block"));
		this.renameActions.add(new RenameItemAction(TFBlocks.blockOre.oreMithril, "Mithril Ore"));
		this.renameActions.add(new RenameTConstructCompatAction("mithril", "Mithril"));
		this.renameActions.add(new RenameFluidAction("mithril.molten", "Molten Mithril"));
		this.renameActions.add(new RenameGenericAction("tile.fluid.molten.mithril.name", "Molten Mithril"));
		this.renameActions.add(new RenameGenericAction("item.tconstruct.bucket.Mithril.name", "Molten Mithril Bucket"));
